		    ...
		    var url = url + '?a=' + adid;
			document.write("<div id='RecentWinnersScroller'  class='recentWinnersLayer' style='width: 150px; height: 412px; font-size: 12px; font: normal normal 400 13px/13px Tahoma; color: #000000;'></div>");
...
function prepXML(s){
	...
	var XMLFeedURL	= 'https://www.wagershare.com/xml/recentwinnersXML.asp?'
